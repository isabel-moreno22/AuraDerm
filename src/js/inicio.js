document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.left-arrow').addEventListener('click', () => moveCarousel(currentIndex - 1));
    document.querySelector('.right-arrow').addEventListener('click', () => moveCarousel(currentIndex + 1));
});
